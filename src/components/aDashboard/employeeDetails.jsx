...
import AllTasks from "../employee/allTasks";
import TodayEmployee from "../employee/todaye";
import WeeklyEmployeeBar from "../employee/weeklyebar";
...
function Details(props) {
  ...
  const getAllTasks = async () => {
    ...
    var response = await axios.post("https://ems-backend-k8b6.onrender.com/getTasksForEmployee", data);
